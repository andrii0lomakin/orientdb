...
public class Status {
  ...
  public static final Status NOT_IMPLEMENTED =
      new Status("NOT_IMPLEMENTED", "The operation is not " +
          "implemented for the current binding.");
  public static final Status UNEXPECTED_STATE =
      new Status("UNEXPECTED_STATE", "The operation reported" +
  ...
  public static final Status BATCHED_OK =
      new Status("BATCHED_OK", "The operation has been batched by " +
